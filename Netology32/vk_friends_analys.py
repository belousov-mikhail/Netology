...
def addMoreFriends(graph, start_node, friends):
...
def printTop (global_dict, most_popular):
    ...
    for el in most_popular:
        id = el[0]
        print ("{0} {1} связан(а) с {2} человек".format(global_dict[id][0], global_dict[id][1], el[1]))
